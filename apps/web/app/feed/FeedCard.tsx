    ...
    <article className="w-full max-w-lg mx-auto bg-gray-800 rounded-2xl overflow-hidden shadow-lg border border-gray-700">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
        <div className="flex items-center gap-2">
          ...
          <span className={`text-sm font-semibold uppercase tracking-wide ${style.accentClass.split(" ")[0]}`}>
      ...
      <div className={`relative flex flex-col items-center justify-center h-48 ${style.backgroundClass} ${style.animationClass}`}>
        {/* Voltage readout */}
        <span className={`text-5xl font-extrabold tabular-nums ${style.accentClass.split(" ")[0]}`}>
        ...
        {technicalMetrics.soc !== undefined && (
          <div className="mt-4 w-2/3">
            ...
            <div className="h-2 w-full rounded-full bg-gray-700">
              <div
                className={`h-2 rounded-full transition-all ${style.accentClass.split(" ")[0].replace("text-", "bg-")}`}
